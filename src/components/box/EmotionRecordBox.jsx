...
const EmotionRecordBox = ({title, alarmChk, write, usrSrveyRsltId, date}) => {
    ...
    return (
        <RecordContent>
            <InnerBox>
                <InfomBox onClick={()=> navigate(URL.HEALTH_DETAIL, {state: {surveyType : "emotion"}})}>
                    ...
                    {write ? (
                        <>
                          <Layout>
                            ...
                            <ControlBox>
                                <ControlTake>
                                    <button onClick={(e)=> {e.stopPropagation();  navigate(URL.EMOTION_WRITE_LIST, {state: {usrSrveyRsltId : usrSrveyRsltId, date: date}})}}><img src={i_modify}></img> 수정</button>
                                </ControlTake>
                            </ControlBox>
                          </Layout>  
                        </>
                     ...
                     <>
                        ...
                        <ControlBox>
                            ...
                            {isPast && <ControlTake>
                                <button onClick={(e)=> {
                                    e.stopPropagation(); 
                                    navigate(URL.EMOTION_ADD, {state: {date : date}});
                                }}> 작성하기</button>
...
export default EmotionRecordBox;
